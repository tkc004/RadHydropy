...
transfer, recombination, collisional ionization,
and hydrodynamic evolution are disabled so that the optional CMB Compton source
term can be compared with its analytic exponential solution.
