...
def top_hat_acceleration(
    radius_comoving_code,
    radius_top_hat_comoving_code,
    overdensity_dimensionless,
    rho_background_comoving_code,
    scale_factor,
    ...
    enclosed_radius_comoving_code = np.minimum(
        radius_comoving_code,
        float(radius_top_hat_comoving_code),
    )
    acceleration = (
        -4.0
        * np.pi
        ...
        * gravitational_constant
        * scale_factor
        * float(overdensity_dimensionless)
        * float(rho_background_comoving_code)
...
def build_initial_condition(config):
    ...
    writer.fluid.rho_radarray = writer.radarray(
        rho_comoving_code * code_units.density_unit,
        representation="comoving",
    )
