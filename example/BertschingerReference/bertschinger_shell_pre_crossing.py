...
def run_pre_crossing(config_filename=DEFAULT_CONFIG):
    ...
    while tau < final_tau - 1.0e-12:
        ...
        radius_proper_code = (
            float(cosmology.scale_factor(time_cosmic_code)) * shells.radius[tracked]
        )
    ...
    figure = (
        ...
        / "BertschingerDarkMatterShellPreCrossingVsODE.jpg"
    )
    ...
    axis.plot(ode.xi, ode.lam, color="black", linewidth=2.0, label="Bertschinger Eq. (4.1)")
