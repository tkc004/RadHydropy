...
ICparams = {
    ...
    'Eini': 1.0e36 * unyt.erg, # the total energy in central region
...
class Simwrap():
    def __init__(self) -> None:
        ...
        self.mesh.area = 1.0 * unyt.pc**2 * np.ones(self.par.nogrid) 
