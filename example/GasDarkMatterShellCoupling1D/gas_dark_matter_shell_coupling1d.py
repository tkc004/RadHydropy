...
from example.GasDarkMatterShellCoupling1D import tools as et
...
def main(config_filename=DEFAULT_CONFIG):
    ...
    gas_mass_error_dimensionless = (
        abs(final_gas_mass_cgs_g - initial_gas_mass_cgs_g) / initial_gas_mass_cgs_g
    )
    ...
    axis.plot(
        radius_proper_pc,
        np.full_like(radius_proper_pc, initial_rho_proper_cgs_g_cm3),
        "--",
        label="initial",
    )
