...
"""Helpers for the Einstein--de Sitter dark-matter shell growth test."""  # noqa: CPY001
...
def volume_midpoint_boundaries(
    ...
    boundaries = np.linspace(
        radius_inner_comoving_code**3,
        radius_outer_comoving_code**3,
        number + 1,
    )
...
def make_shells(config, overdensity=None):
    ...
    inner_boundaries = volume_midpoint_boundaries(
        radius_inner_comoving_code,
        radius_perturbation_comoving_code,
        number_inner,
    )
    ...
    vel_supercomoving_code[inside] = (
        -(scale_factor_dimensionless**2) * hubble_code * delta * radius_comoving_code[inside] / 3.0
    )
    vel_supercomoving_code[~inside] = (
        -(scale_factor_dimensionless**2)
        * hubble_code
        * delta
        * radius_perturbation_comoving_code**3
...
def lagrangian_boundary_acceleration(
    radius_comoving_code,
    enclosed_mass_comoving_code,
    rho_comoving_code,
    scale_factor,
    code_unit_system,
):
    ...
    return (
        -g_code
        * scale_factor
        * (enclosed_mass_comoving_code - background_mass_comoving_code)
...
def step_lagrangian_boundary(
    radius_comoving_code,
    vel_supercomoving_code,
    dt_supercomoving_code,
    enclosed_mass_comoving_code,
    rho_comoving_start_code,
    rho_comoving_end_code,
    scale_factor_start,
    scale_factor_end,
    code_unit_system,
):
