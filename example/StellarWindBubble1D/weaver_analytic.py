...
def wind_luminosity(rho_outflow_proper_unyt, vel_outflow_proper_unyt, radius_injection_proper_unyt):
    ...
    luminosity_proper_cgs_erg_s = (
        2.0
        * math.pi
        * radius_injection_proper_cgs_cm**2
        * rho_outflow_proper_cgs_g_cm3
        * vel_outflow_proper_cgs_cm_s**3
    )
...
def shock_radius(
    ...
    radius_shock_proper_cgs_cm = (
        WEAVER_RADIUS_COEFFICIENT
        * (luminosity_proper_cgs_erg_s / rho_ambient_proper_cgs_g_cm3) ** 0.2
        * time_proper_cgs_s**0.6
    )
...
def shock_velocity(
    ...
    radius_shock_proper_unyt = shock_radius(
        time_proper_code,
        rho_ambient_proper_unyt,
        rho_outflow_proper_unyt,
        vel_outflow_proper_unyt,
...
def bubble_pressure(
    ...
    pressure_bubble_proper_cgs_dyn_cm2 = (
        WEAVER_PRESSURE_COEFFICIENT
        * luminosity_proper_cgs_erg_s**0.4
        * rho_ambient_proper_cgs_g_cm3**0.6
        * time_proper_cgs_s ** (-0.8)
    )
