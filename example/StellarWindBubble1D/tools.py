...
def collect_shell_diagnostics(snapshots, config):
    ...
    radii_shell_proper_unyt = unyt.unyt_array(
        [
            radius_shell_proper_unyt.to_value(unyt.pc)
            for radius_shell_proper_unyt in radii_shell_proper_unyt
        ],
        unyt.pc,
    )
    pressures_bubble_proper_unyt = unyt.unyt_array(
        [
            pressure_bubble_proper_unyt.to_value(unyt.dyn / unyt.cm**2)
            for pressure_bubble_proper_unyt in pressures_bubble_proper_unyt
        ],
        unyt.dyn / unyt.cm**2,
    )
    ...
    radius_shell_proper_pc = np.array(
        [
            float(radius_shell_proper_unyt.to_value(unyt.pc))
            for radius_shell_proper_unyt in radii_shell_proper_unyt
        ],
        dtype=float,
    )
    ...
    for time_proper_unyt in times_proper_unyt:
        radius_shock_proper_unyt, vel_shock_proper_unyt, pressure_bubble_proper_unyt = (
            wa.weaver_solution(
                time_proper_unyt,
                initial_config["rho_proper"],
                config["par"]["boundary"]["rho_outflow_proper"],
