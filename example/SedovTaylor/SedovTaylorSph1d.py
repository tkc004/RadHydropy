...
ICparams = {
    ...
    'Eini': 1.0e-2 * unyt.erg, # the total energy in central region
    #'Eini': 0.0 * unyt.erg, # the total energy in central region
    'rini': 1.0 * unyt.cm, # radius of central region
    'muini': 1.0,
}
...
class Simwrap():
    def __init__(self) -> None:
        ...
        self.fluid.temp = np.zeros(self.par.nogrid) * unyt.K
