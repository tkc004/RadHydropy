...
def getRs(E0,A0,nu,w,alpha,t):
    ...
    nu is the dimension
    w  is the power-law index: initial density profile from rho0 = A0 r^-w
...
def integral_solution(nu,g,w):
    """
    Integrate the solution to get the integral factor alpha
    and the dimensionless solution
    """
    wa = get_wa(nu,g)
