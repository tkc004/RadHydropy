...
def RunHydrogenPhotoheating(sim, source_switch_time, photon_density_on, outputtime=0):  # noqa: N802
    ...
    if output_times is not None:
        ...
        output_times = [
            ...
            if value * target_unit > sim.fluid.time_proper_code * time_unit
            and value * target_unit <= final_time
        ]
    else:
    ...
    while sim.fluid.time_proper_code * time_unit < final_time:
        ...
        elif next_output_time is not None and time_proper < next_output_time < time_proper + dt:
