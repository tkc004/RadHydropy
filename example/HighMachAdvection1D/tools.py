...
def build_initial_condition(config):
    ...
    if "temp_left" in initial or "temp_right" in initial:
        temp_proper_code=np.where(left,initial.get("temp_left",initial.get("initial_temperature",0)),initial.get("temp_right",initial.get("initial_temperature",0)))
