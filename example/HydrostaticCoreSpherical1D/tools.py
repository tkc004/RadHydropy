...
"""Analytic setup and diagnostics for the pressure-supported core test."""  # noqa: CPY001
...
def point_mass_density(
    ...
    return rho_ref_cgs * np.exp(-potential_difference / sound_speed_squared) * (unyt.g / unyt.cm**3)
