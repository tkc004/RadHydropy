...
photon rate to the next cell. The ``instantaneous`` scheme remains available
when explicitly selected. The current C²-Ray implementation supports the hydrogen network;
